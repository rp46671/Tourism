...
if (($_SESSION['admin'])!=1) {
        ...
        $qur=mysqli_query($con,"select * from package");
        ...
        <div class="page-container">
           ...
           <?php include 'includes/header.php'; ?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30" style="line-height: 250px;">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select class="form-control" id="select" style="display: inline;">
                                                        <option disabled selected value>Select Package</option>
                                                            <?php while ($arr=mysqli_fetch_array($qur)) {?>
                                                                <option value="editpackage.php?mid=<?php echo $arr['Packid']; ?>"><?php echo $arr['packname'] ?></option><?php
                                                            } ?>
                                                    </select>
   ...
   <!--   --><!-- <script src="js/main.js"></script> -->
    <script>
        ...
        $('#select').change(function(){
            var url=this.value;
            if (url==='null') {
                $('#error').html("Select one of the package");
            }
                else {
            window.location=url;}
        });
