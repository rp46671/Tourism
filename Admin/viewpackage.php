                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr class="tr-shadow">
                                                ...
                                                <td><img src="upload_images/<?php echo $row['Pic1'];?>"  width=30px></td>
                                                <td><a href="javascript:slider_id(<?php echo $row['Packid']; ?>)"class='sliclick'>Click</a></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <a href="editpackage.php?mid=<?php echo $row['Packid'];?>"><i class="zmdi zmdi-edit"></i></a>
                                                        </button>

                                                            <button  class="item" data-toggle="tooltip" data-placement="top" title="Delete" name="delete">
                                                              <a href="javascript:delete_id(<?php echo $row['Packid'];?>)"><i class="zmdi zmdi-delete"></i>s</a>
                                                            </button>
                                                    </div>
